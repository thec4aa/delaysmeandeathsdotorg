...
gulp.task('scripts', function() {
    var scripts = [
        ...
        // basePaths.dev + 'js/skrollr.min.js',
        // basePaths.dev + 'js/skrollr.menu.min.js',
        basePaths.dev + 'js/countUp.min.js', // include countup
        basePaths.dev + 'js/child-theme-custom-stuff.js' // include child theme changes
    ];
  gulp.src(scripts)
...
// CountUp JS files
    gulp.src(basePaths.node + 'countup.js/dist/*.js')
        .pipe(gulp.dest(basePaths.dev + '/js'));
